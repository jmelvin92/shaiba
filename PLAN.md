...
| 6.8 | The sand worm — desert mob | `feature/sand-worm` | 🟡 Parts 1–2 ✅; Part 3 planned with Joshua & **built 2026-08-23** — noise wakes it (WormDirector), seek→prowl→stalk→strike hunt, telegraphed escape beat, swallow→reload-save death, safe ground/silence/sprint-to-cover all real. All 44 gate checks + full battery green. **Open: Joshua's hunt playtest (F10 to summon one)** — feel tuning + his look sign-off close the phase. Merges after 6.7 |
