...
| 6.8 | The sand worm — desert mob | `feature/sand-worm` (not yet created) | 🔲 Planned 2026-08-22 — vision + planning calls recorded (Tremors-style mound, noise attraction, incredibly-rare enemy with kill animations); scale via in-game size ladder; death design deferred to Part 3 planning. **Build starts only when Joshua says go** |
